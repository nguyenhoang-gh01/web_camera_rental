export const elements = {
  ...
  summaryReviews: document.querySelector("[data-summary-reviews]"),
  ...
  companyCategorySelect: document.querySelector("[data-company-category-select]"),
  companyNameInput: document.querySelector("[data-company-name-input]"),
  companiesBody: document.querySelector("[data-admin-companies-body]"),
  ...
  reviewSearch: document.querySelector("[data-review-search]"),
  reviewRatingFilter: document.querySelector("[data-review-rating-filter]"),
  reviewList: document.querySelector("[data-admin-review-list]"),
